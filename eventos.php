	...
	<div class="container">
		...
		<div class="row row-bottom-padded-md">
			...
			while($noticias = mysqli_fetch_array($query)) {
				$id = $noticias['idEventos'];
				$titulo = $noticias['titulo'];
				$subtitulo = $noticias['data'];
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="cpanel/evento/paginas/<?php echo $titulo;?>.php"><div class="noticiasimg" style="margin-bottom: 20px;"><img class="noticiasimginside" src="cpanel/uploadsImages/<?php echo $imagem;?>" alt="Card image cap"></div></a>
						<div class="blog-text">
							<h3 style="max-height: 6rem; min-width: 6rem; overflow: hidden;"><a href="cpanel/evento/paginas/<?php echo $titulo;?>.php" ><?php echo $noticias['titulo'];?></a></h3>							
							<p style="color: black;">Data: <?php echo $noticias['data'];?></p>
							<span class="posted_on"><?php echo $noticias['publicacao'];?></span>

							<p align="justify"><?php  echo substr($texto, 0, 200) . "...";?></p>
							<a href="cpanel/evento/paginas/<?php echo $titulo;?>.php" class="btn btn-primary">Ler tudo</a>
						</div> 
					</div>
				</div>				
...
<!-- FIM notícias-->
<footer style="background: #11678c;"class="final">
