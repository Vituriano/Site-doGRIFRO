	...
	<div class="container">
		<div id="fh5co-blog" class="fh5co-bg-section">
			<div class="text-center fh5co-heading animate-box">
				<h2 style="color: white;">Editais em aberto</h2>
			</div>
		</div>
			...
			while($noticias = mysqli_fetch_array($query)) {
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="cpanel/noticia/paginas/<?php echo $titulo;?>.php"><div class="noticiasimg" style="margin-bottom: 20px;"><img class="noticiasimginside" src="cpanel/uploadsImages/<?php echo $imagem;?>" alt="Card image cap"></div></a>
						<div class="blog-text">
							<h3 style="max-height: 6rem; min-width: 6rem; overflow: hidden;"><a href="cpanel/noticia/paginas/<?php echo $titulo;?>.php" ><?php echo $noticias['titulo'];?></a></h3>
							<span class="posted_on"><?php echo $publicacao; ?></span>
							<h5 class="text-muted" style="max-height: 3rem; min-width: 3rem; overflow: hidden;"><?php echo $noticias['subtitulo'];?></h5>
							<p align="justify"><?php  echo substr($texto, 0, 200) . "...";?></p>
							<a href="cpanel/edital/paginas/<?php echo $titulo;?>.php" class="btn btn-primary">Ler tudo</a>
						</div> 
					</div>
				</div>							
...
<!-- FIM notícias-->
<footer style="background: #1d6d20;"class="final">
