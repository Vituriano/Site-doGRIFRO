...
<body style="background:#eaeaea91;">
	...
	<div style="background-color: white;">
		...
		<ul class="container nav nav-tabs">
			...
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle active" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Admnistradores</a>
				<div class="dropdown-menu">
					<a class="dropdown-item" href="insereadm.php">Inserir Adm</a>
					<a class="dropdown-item" href="editaadm.php">Atualizar Adm</a>
					<a class="dropdown-item" href="excluiadm.php">Remover Adm</a>
				</div>
			</li>
		</ul>
	</div>
	...
	<?php $adm = $_SESSION['usuarioNome'];	?>
	<div class="container">
		<?php
		include "../conexao.php";

		$sql = "SELECT * FROM usuarios WHERE adm = '0' ORDER BY idusuarios DESC";
			...
			<form id="form1" method="post" action="">
				<div class="list-group">
					...
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-2"><?php echo $usuarios["nome"]; ?></h5>
					</div>	
				</div>
				<INPUT TYPE="hidden" NAME="idusuarios" VALUE="<?php echo $usuarios['idusuarios']; ?>" />
				<button name='1' class='btn btn-danger' id="myBtn<?php echo $usuarios['idusuarios']; ?>" style='color: #FFF;'>Excluir</button>
				<hr>
			</form>	
		<?php } 	
		...
		if (isset($_POST["idusuarios"])) {
			$id = $_POST['idusuarios'];
			?>
			<form method="post" action="deleteadm.php">
