...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		<form class="formulario" method="post" action="updateadm1.php" enctype="multipart/form-data">
			<h1>Nome</h1>
			<br class="clearBoth">
			<input type="text" required class="form-control" id="titulo" name="titulo" value="<?php echo $nome;  ?>">
			...
			<br class="clearBoth">
			<input type="url" required class="form-control" id="link" name="link" value="<?php echo $link;  ?>">
			<br class="clearBoth"><br class="clearBoth">

			<h1>Senha</h1>
			<br class="clearBoth">
			<input type="password" required class="form-control" id="Senha" name="senha" value="<?php echo $senha;  ?>">
			<br class="clearBoth"><br class="clearBoth">

			<INPUT TYPE="hidden" NAME="idusuarios" VALUE="<?php echo $id;?>" />
			<a style="color: #FFF;" href="editaadm.php" class="btn btn-danger">Cancelar</a>
