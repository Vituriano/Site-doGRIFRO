...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		<?php
		if(isset($_SESSION['admrepetido'])){
			echo "<div class='alert alert-danger'>".$_SESSION['admrepetido']."</div>";
			unset($_SESSION['admrepetido']);
		}
		?>

		<form class="formulario" method="post" action="insertadm.php" enctype="multipart/form-data">
			<h1>Nome</h1>
			<br class="clearBoth">
			<input type="text" required class="form-control" id="titulo" name="titulo" placeholder="Nome aqui">
			...
			<h1>Link para Rede Social</h1>
			<br class="clearBoth">
			<input type="url" required class="form-control" id="link" name="link" placeholder="Link aqui">
			<br class="clearBoth"><br class="clearBoth">

			<h1>Senha</h1>
			<br class="clearBoth">
			<input type="password" required class="form-control" id="senha" name="senha" placeholder="Senha aqui">
			<br class="clearBoth"><br class="clearBoth">
