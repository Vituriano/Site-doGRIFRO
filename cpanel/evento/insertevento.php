...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		...
		if(!$validations){
			...
			$query = "INSERT INTO eventos (titulo, data, imagem, texto, publicacao, atualizacao) VALUES('$titulo', '$data', '$novo_nome' /*referente à imagem*/, '$texto', '$publicacao', '$atualizacao');";
			...
			<center>
			<p class='subtitulo'><b>O evento ocorrerá em <?php echo $subtitulo1;?>, podendo haver alterações no cronograma.</b></p>
			<img style='width: 80%; height: auto;' src='../../uploadsImages/<?php echo  $imagem1;?>'></center>
			...
			$_SESSION['eventorepetido'] = "Esse evento já foi publicado anteriormente";
			echo'<META HTTP-EQUIV=Refresh CONTENT="0; URL=inserirevento.php">';
		}?>
		<style type="text/css">
		.imgupdate{
			width: 60%;
