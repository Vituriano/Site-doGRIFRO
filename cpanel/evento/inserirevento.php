...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		...
		<?php
		if(isset($_SESSION['eventorepetido'])){
			echo "<div class='alert alert-danger'>".$_SESSION['eventorepetido']."</div>";
			unset($_SESSION['eventorepetido']);
		}
		?>
		<form class="formulario" method="post" action="insertevento.php" enctype="multipart/form-data">
			<h1>Título</h1>
			<br class="clearBoth">
