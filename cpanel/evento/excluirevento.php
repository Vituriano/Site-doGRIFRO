...
<body style="background:#eaeaea91;">
			...
			<form id="form1" method="post" action="">
				<div class="list-group">
					...
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-2"><?php echo $evento["titulo"]; ?></h5>
					</div>	
					<p class="mb-1 text-muted"><?php echo $evento["data"]; ?></p>
				</div>
				<INPUT TYPE="hidden" NAME="idEventos" VALUE="<?php echo $evento['idEventos']; ?>" />
				<button name="1" class='btn btn-danger' id="myBtn<?php echo $evento['idEventos'];?>" style='color: #FFF;'>Excluir</button>
			</a>
			<hr>
		</form>	
	<?php } 	
	if (isset($_POST["idEventos"])) {
		$id = $_POST['idEventos'];
		?>
		<form method="post" action="deleteevento.php">
					...
					<center>
						<div style="width: 50%;">
							<p class='text-muted'>Tem certeza que deseja Excluir?<br><br>
								<span>
									<INPUT TYPE="hidden" NAME="idEventos" VALUE="<?php echo $id; ?>" />
