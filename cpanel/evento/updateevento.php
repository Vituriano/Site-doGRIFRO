...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		<form class="formulario" method="post" action="updateevento1.php" enctype="multipart/form-data">
			<h1>Título</h1>
			<br class="clearBoth">
			...
			<a style="color: #FFF;" href="editarevento.php" class="btn btn-danger">Cancelar</a>
