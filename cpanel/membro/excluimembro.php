...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		<?php
		include "../conexao.php";
		$sql = "SELECT * FROM membros ORDER BY idmembro DESC";
			...
			<form id="form1" method="post" action="">
				<div class="list-group">
					...
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-2"><?php echo $membro["nome"]; ?></h5>
					</div>	
					<p class="mb-1 text-muted"><?php echo $membro["ano_atuacao"]; ?></p>
				</div>
				<INPUT TYPE="hidden" NAME="idmembro" VALUE="<?php echo $membro['idmembro']; ?>" />
				<button name="1" class='btn btn-danger' id="myBtn<?php echo $membro['idmembro'];?>" style='color: #FFF;'>Excluir</button>
			</a>
			<hr>
		</form>	
	<?php } 	
	if (isset($_POST["idmembro"])) {
		$id = $_POST['idmembro'];
		?>
