...
<body style="background:#eaeaea91;">
	...
	<div style="background-color: white;">
		...
		<ul class="container nav nav-tabs">
			...
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle active" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Membros</a>
				<div class="dropdown-menu">
					<a class="dropdown-item" href="inseremembro.php">Inserir Membro</a>
					<a class="dropdown-item" href="editamembro.php">Atualizar Membro</a>
					<a class="dropdown-item" href="excluimembro.php">Remover Membro</a>
				</div>
			</li>
			<li class="nav-item dropdown">
	...
	<div class="container">
		...
		while ($membro = mysqli_fetch_array($query)) {
			$id = $membro['idmembro'];
			$nome = $membro["nome"];
			$ano = $membro["ano_atuacao"];
			$cargo = $membro["cargo"];
			$twitter = $membro["twitter"];
			$facebook = $membro["facebook"];
	...
	<div class="container">
		<form class="formulario" method="post" action="updatemembro1.php" enctype="multipart/form-data">
			<h1>Nome</h1>
			<br class="clearBoth">
			<input type="text" required class="form-control" maxlength="25" id="titulo" name="titulo" placeholder="Insira somente o primeiro e o último nome">
			<small id="emailHelp" class="form-text text-muted"><?php echo $nome;  ?></small>
			<br class="clearBoth"><br class="clearBoth">

			<h1>Ano de atuação</h1>
			<br class="clearBoth">
			<input type="number" required class="form-control" maxlength="4" id="ano" name="ano" placeholder="Ano aqui">
			<small id="emailHelp" class="form-text text-muted"><?php echo $ano;  ?></small>
			<br class="clearBoth"><br class="clearBoth">

			<h1>Cargo</h1>
			<br class="clearBoth">
			<input type="text" required class="form-control" id="cargo" name="cargo" placeholder="Cargo aqui">
			<small id="emailHelp" class="form-text text-muted"><?php echo $cargo;  ?></small>
			<br class="clearBoth"><br class="clearBoth">

			<h1>Link do perfil no Twitter</h1>
			<br class="clearBoth">
			<input type="url" required class="form-control" id="twitter" name="twitter" placeholder="Twitter aqui">
			<small id="emailHelp" class="form-text text-muted"><?php echo $twitter;  ?></small>
			<br class="clearBoth"><br class="clearBoth">

			<h1>Link do perfil no Facebook</h1>
			<br class="clearBoth">
			<input type="url" required class="form-control" id="facebook" name="facebook" placeholder="Facebook aqui">
			<small id="emailHelp" class="form-text text-muted"><?php echo $facebook;  ?></small>
			<br class="clearBoth"><br class="clearBoth">

			<h1>Link do perfil no Linkedin</h1>
			<br class="clearBoth">
			<input type="url" required class="form-control" id="linkedin" name="linkedin" placeholder="Linkedin aqui">
			<small id="emailHelp" class="form-text text-muted"><?php echo $linkedin;  ?></small>
			<br class="clearBoth"><br class="clearBoth">

			<h1>Endereço de E-mail</h1>
			<br class="clearBoth">
			<input type="email" required class="form-control" id="email" name="email" placeholder="E-mail aqui">
			<small id="emailHelp" class="form-text text-muted"><?php echo $email;  ?></small>
			<br class="clearBoth"><br class="clearBoth">
			...
			<div class='input-wrapper'>
				...
				<small id="emailHelp" class="form-text text-muted">Anexar arquivos de no máximo 2MB e de preferência nas proporções 3x4</small>
			</div>
			<br class="clearBoth"><br class="clearBoth">
			<INPUT TYPE="hidden" NAME="idmembro" VALUE="<?php echo $id;?>" />
			<a style="color: #FFF;" href="editamembro.php" class="btn btn-danger">Cancelar</a>
