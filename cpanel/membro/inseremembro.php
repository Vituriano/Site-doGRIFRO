...
<body style="background:#eaeaea91;">
	...
	<div style="background: #253f55;">
		<h3 style="color: white; padding: 10px;" class="container text-center">Inserir Dados</h3>
	</div>
	<div class="container">
		<?php
		if(isset($_SESSION['membrorepetido'])){
			echo "<div class='alert alert-danger'>".$_SESSION['membrorepetido']."</div>";
			unset($_SESSION['membrorepetido']);
		}
		?>
		<form class="formulario" method="post" action="insertmembro.php" enctype="multipart/form-data">
			<h1>Nome</h1>
			<br class="clearBoth">
			...
			<br class="clearBoth">
			<input type="number" required class="form-control" maxlength="4" id="ano" name="ano" placeholder="Ano de atuação aqui">
			<br class="clearBoth"><br class="clearBoth">
