...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		<?php
		include "../conexao.php";
		$sql = "SELECT * FROM estatuto ORDER BY idestatuto DESC";
			...
			<form id="form1" method="post" action="">
				<div class="list-group">
					...
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-2">Estatuto</h5>
					</div>	
					<p class="mb-1 text-muted"><?php echo $noticia["data"]; ?></p>
				</div>
				<INPUT TYPE="hidden" NAME="idestatuto" VALUE="<?php echo $noticia['idestatuto']; ?>" />
				<button name="1" class='btn btn-danger' id="myBtn<?php echo $noticia['idestatuto'];?>" style='color: #FFF;'>Excluir</button>
			</a>
			<hr>
		</form>	
	<?php } 	
	if (isset($_POST["idestatuto"])) {
		$id = $_POST['idestatuto'];
		?>
		<form method="post" action="deleteestatuto.php">
