...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		<?php
		if(isset($_SESSION['estatutorepetido'])){
			echo "<div class='alert alert-danger'>".$_SESSION['estatutorepetido']."</div>";
			unset($_SESSION['estatutorepetido']);
		}
		?>

		<form class="formulario" method="post" action="insertestatuto.php" enctype="multipart/form-data">
