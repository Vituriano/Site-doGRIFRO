...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		<form class="formulario" method="post" action="updateatividade1.php" enctype="multipart/form-data">
			<h1>Título</h1>
			<br class="clearBoth">
			<input type="text" required class="form-control" id="title" name="titulo">
			<small id="emailHelp" class="form-text text-muted"><?php echo $titulo;  ?></small>
			<br class="clearBoth"><br class="clearBoth">

			<h1>Descrição</h1>
			<br class="clearBoth">
			<input type="text" required class="form-control" id="subtitulo" name="subtitulo">
			<small id="emailHelp" class="form-text text-muted"><?php echo $descricao;  ?></small>
			<br class="clearBoth"><br class="clearBoth">
			...
			<h1>Texto</h1>
			<br class="clearBoth">
			<textarea required class="form-control" id="text" name="texto" rows="6"></textarea>
			<small id="emailHelp" class="form-text text-muted"><?php echo $texto;  ?></small>
			<br class="clearBoth"><br class="clearBoth">

			<INPUT TYPE="hidden" NAME="idatividades" VALUE="<?php echo $id;?>" />
			<a style="color: #FFF;" href="editaratividade.php" class="btn btn-danger">Cancelar</a>
