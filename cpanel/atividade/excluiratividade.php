...
<body style="background:#eaeaea91;">
	...
	<div style="background: #253f55;">
		<h3 style="color: white; padding: 10px;" class="container text-center">Excluir Dados</h3>
	</div>
	<div class="container">
		<?php
		include "../conexao.php";
			...
			<form id="form1" method="post" action="">
				<div class="list-group">
					...
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-2"><?php echo $atividade["titulo"]; ?></h5>
					</div>	
					<p class="mb-1 text-muted"><?php echo $atividade["descricao"]; ?></p>
				</div>
				<INPUT TYPE="hidden" NAME="idatividades" VALUE="<?php echo $atividade['idatividades']; ?>" />
				<button name="1" class='btn btn-danger' id="myBtn<?php echo $atividade['idatividades'];?>" style='color: #FFF;'>Excluir</button>
			</a>
			<hr>
		</form>	
	<?php } 	
	if (isset($_POST["idatividades"])) {
		...
		?>
		<form method="post" action="deleteatividade.php">
			<div id="myModal<?php echo $id;?>" class="modal">
				<div class="modal-content">
					<br>
					<center>
						<div style="width: 50%;">
							<p class='text-muted'>Tem certeza que deseja Excluir?<br><br>
								<span>
									<INPUT TYPE="hidden" NAME="idatividades" VALUE="<?php echo $id; ?>" />
									<button name="2" style="float: left;" class='btn btn-success' style='color: #FFF;'>Sim</button>
								</span>
								<span  class="close<?php echo $id; ?>">
									<a style="float:right;color: #FFF;" class='btn btn-secondary'>Não</a>
								</span>
							</p>
						</div>
					</center>
			...
			<script type="text/javascript">
				...
				var btn = document.getElementById("myBtn<?php echo $id; ?>");

				var modal = document.getElementById("myModal<?php echo $id; ?>");


				var span = document.getElementsByClassName("close<?php echo $id; ?>")[0];
