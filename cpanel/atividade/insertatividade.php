...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		...
		if(!$validations){
			...
			$query = "INSERT INTO atividades (titulo, descricao, imagem, texto, publicacao, atualizacao) VALUES('$titulo', '$descricao', '$novo_nome' /*referente à imagem*/, '$texto', '$publicacao', '$atualizacao');";
			...
			$_SESSION['atividaderepetida'] = "Essa atividade já foi publicada anteriormente";
			echo'<META HTTP-EQUIV=Refresh CONTENT="0; URL=inseriratividade.php">';
		}?>
		<style type="text/css">
		.imgupdate{
			width: 60%;
