...
<body style="background:#eaeaea91;">
	...
	<div style="background-color: white;">
		...
		<ul class="container nav nav-tabs">
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle active" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Atividades</a>
				<div class="dropdown-menu">
					<a class="dropdown-item" href="inseriratividade.php">Inserir Atividade</a>
					<a class="dropdown-item" href="editaratividade.php">Atualizar Atividade</a>
					<a class="dropdown-item" href="excluiratividade.php">Remover Atividade</a>
				</div>
			</li>
			<li class="nav-item dropdown">
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="../edital/inserirevento.php">Inserir Evento</a>
					<a class="dropdown-item" href="../edital/editarevento.php">Editar Evento</a>
					<a class="dropdown-item" href="../edital/excluirevento.php">Remover Evento</a>
				</div>
			</li>
			<li class="nav-item dropdown">
	...
	<div class="container">
		...
		$texto = $_POST["texto"];
		$titulo1 = "";
		$search = "SELECT idatividades FROM atividades WHERE titulo = '$titulo'";
		...
		if(!$validations or $a == $b){
			$sql_unlike = "SELECT * FROM atividades WHERE idatividades = '$id'";
			...
			$query = "UPDATE atividades SET titulo = '$titulo', descricao = '$descricao', imagem = '$novo_nome', texto = '$texto', atualizacao = '$atualizacao' WHERE idatividades = '$id'";

			$texto = nl2br($texto);

			if (mysqli_query($con, $query)) {

				while ($noticia = mysqli_fetch_array($query_unlike)) {
					$tituloo = $noticia['titulo'];
					$imagem = $noticia['imagem'];
					unlink("paginas/".$tituloo.".php");
					unlink("../uploadsImages/".$imagem);
				}
				$sql = "SELECT * from atividades where idatividades = (select max(idatividades) from atividades)";
				...
				while (".$atividade." = mysqli_fetch_array(".$query.")) {
					".$id1." = ".$atividade."['idatividades'];
					".$titulo1." = ".$atividade."['titulo'];
					".$subtitulo1." = ".$atividade."['descricao'];
					".$imagem1." = ".$atividade."['imagem'];
					".$texto1." = ".$atividade."['texto'];
					".$texto1." = nl2br(".$texto1.");
					".$publicacao1." = ".$atividade."['publicacao'];
					".$atualizacao1." = ".$atividade."['atualizacao'];
				}
				...
				printf(" <center>
					...
					<a  style='float:right;' href='editaratividade.php'>
					</center>
					<button type='button' class='btn btn-success'>Continuar</button>
					</a>
					<br><br>", $titulo, $descricao, $novo_nome, $texto);
			...
			echo '<script type="text/javascript">alert("Não foi possivel fazer as mudanças, existe uma notícia com mesmo título já cadastrada");</script>';
			echo'<META HTTP-EQUIV=Refresh CONTENT="0; URL=editaratividade.php">';
		}
		?>
