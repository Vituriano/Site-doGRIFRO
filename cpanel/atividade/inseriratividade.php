...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		...
		<?php
		if(isset($_SESSION['atividaderepetida'])){
			echo "<div class='alert alert-danger'>".$_SESSION['atividaderepetida']."</div>";
			unset($_SESSION['atividaderepetida']);
		}
		?>
		<form class="formulario" method="post" action="insertatividade.php" enctype="multipart/form-data">
			<h1>Título</h1>
			<br class="clearBoth">
			<input type="text" required class="form-control" id="titulo" name="titulo" placeholder="título aqui">
			<br class="clearBoth"><br class="clearBoth">

			<h1>Descrição</h1>
			<br class="clearBoth">
			<input type="text" required class="form-control" id="subtitulo" name="subtitulo" placeholder="subtítulo aqui">
			<br class="clearBoth"><br class="clearBoth">
			...
			<h1>Texto</h1>
			<br class="clearBoth">
			<textarea class="form-control" required id="texto" name="texto" rows="6"></textarea>
			<br class="clearBoth"><br class="clearBoth">
