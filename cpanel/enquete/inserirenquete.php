...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		...
		<?php
		if(isset($_SESSION['enqueterepetida'])){
			echo "<div class='alert alert-danger'>".$_SESSION['enqueterepetida']."</div>";
			unset($_SESSION['enqueterepetida']);
		}
		?>
		<form class="formulario" method="post" action="insertenquete.php" enctype="multipart/form-data">
			<h1>Título</h1>
			<br class="clearBoth">
			...
			<h1>Descrição</h1>
			<br class="clearBoth">
			<input type="text" required class="form-control" id="subtitulo" name="subtitulo" placeholder="Máximo 200 caracteres">
			<br class="clearBoth"><br class="clearBoth">
