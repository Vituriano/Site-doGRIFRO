...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		...
		while ($enquete = mysqli_fetch_array($query)) {
			$id = $enquete['idEnquete'];
			$titulo = $enquete['titulo'];
			$descricao = $enquete['texto'];
	...
	<div class="container">
		<form class="formulario" method="post" action="updateenquete1.php" enctype="multipart/form-data">
			<h1>Título</h1>
			<br class="clearBoth">
			...
			<h1>Link para o Google Forms</h1>
			<br class="clearBoth">
			<input type="url" required class="form-control" id="link" name="link">
			<small id="emailHelp" class="form-text text-muted"><?php echo $link;  ?></small>
			<br class="clearBoth"><br class="clearBoth">

			<INPUT TYPE="hidden" NAME="idEnquete" VALUE="<?php echo $id;?>" />
			<a style="color: #FFF;" href="editarenquete.php" class="btn btn-danger">Cancelar</a>
