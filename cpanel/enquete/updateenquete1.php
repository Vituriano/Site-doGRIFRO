...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		...
		if(!$validations or $a == $b){
			$sql_unlike = "SELECT * FROM enquetes WHERE idEnquete = '$id'";
			...
			$query = "UPDATE enquetes SET titulo = '$titulo', texto = '$descricao', imagem = '$novo_nome', link = '$link', atualizacao = '$atualizacao' WHERE idEnquete = '$id'";
			...
			echo '<script type="text/javascript">alert("Não foi possivel fazer as mudanças, existe uma enquete com mesmo título já cadastrada");</script>';
			echo'<META HTTP-EQUIV=Refresh CONTENT="0; URL=editarenquete.php">';
		}
		?>
