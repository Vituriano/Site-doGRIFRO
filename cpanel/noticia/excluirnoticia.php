...
<body style="background:#eaeaea91;">
	...
	<div style="background-color: white;">
		...
		<ul class="container nav nav-tabs">
			...
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle nav-link active" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Notícias</a>
				<div class="dropdown-menu">
					<a class="dropdown-item" href="inserirnoticia.php">Inserir Notícia</a>
					<a class="dropdown-item" href="editarnoticia.php">Editar Notícia</a>
					<a class="dropdown-item" href="excluirnoticia.php">Remover Notícia</a>
				</div>
			</li>
			<li class="nav-item dropdown">
	...
	<div class="container">
		...
		while ($noticia = mysqli_fetch_array($query)) { 
			$array[] = $noticia['idNoticias'];
			?>
			<form id="form1" method="post" action="">
				<div class="list-group">
					<br class="clearBoth">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-2"><?php echo $noticia["titulo"]; ?></h5>
					</div>	
					<p class="mb-1 text-muted"><?php echo $noticia["subtitulo"]; ?></p>
				</div>
				<INPUT TYPE="hidden" NAME="idNoticias" VALUE="<?php echo $noticia['idNoticias']; ?>" />
				<button name="1" class='btn btn-danger' id="myBtn<?php echo $noticia['idNoticias'];?>" style='color: #FFF;'>Excluir</button>
			</a>
			<hr>
		</form>	
	<?php } 	
					...
					<center>
						<div style="width: 50%;">
							<p class='text-muted'>Tem certeza que deseja Excluir?<br><br>
								<span>
									<INPUT TYPE="hidden" NAME="idNoticias" VALUE="<?php echo $id; ?>" />
