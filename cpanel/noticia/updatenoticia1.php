...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		...
		$texto = $_POST["texto"];
		$titulo1 = "";
		$search = "SELECT idNoticias FROM noticias WHERE titulo = '$titulo'";
		...
		if(!$validations or $a == $b){
			$sql_unlike = "SELECT * FROM noticias WHERE idNoticias = '$id'";
			...
			$query = "UPDATE noticias SET titulo = '$titulo', subtitulo = '$subtitulo', imagem = '$novo_nome', texto = '$texto', atualizacao = '$atualizacao' WHERE idNoticias = '$id'";
			...
			if (mysqli_query($con, $query)) {
				...
				$sql = "SELECT * from noticias where idNoticias = (select max(idNoticias) from noticias)";
				...
				printf(" <center>
					...
					<a  style='float:right;' href='editarnoticia.php'>
					</center>
			...
			echo'<META HTTP-EQUIV=Refresh CONTENT="0; URL=editarnoticia.php">';
		}
		?>
