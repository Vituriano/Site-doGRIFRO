...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		<form class="formulario" method="post" action="updatenoticia1.php" enctype="multipart/form-data">
			<h1>Título</h1>
			<br class="clearBoth">
			...
			<h1>Subtítulo</h1>
			<br class="clearBoth">
			<input type="text" required class="form-control" id="subtitle" name="subtitulo">
			<small id="emailHelp" class="form-text text-muted"><?php echo $subtitulo;  ?></small>
			<br class="clearBoth"><br class="clearBoth">
			...
			<a style="color: #FFF;" href="editarnoticia.php" class="btn btn-danger">Cancelar</a>
