...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		...
		<?php
		if(isset($_SESSION['noticiarepetida'])){
			echo "<div class='alert alert-danger'>".$_SESSION['noticiarepetida']."</div>";
			unset($_SESSION['noticiarepetida']);
		}
		?>
		<form class="formulario" method="post" action="insertNoticia.php" enctype="multipart/form-data">
			<h1>Título</h1>
			<br class="clearBoth">
