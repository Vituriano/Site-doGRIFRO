...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		...
		if(!$validations){
			...
			$query = "INSERT INTO noticias (titulo, subtitulo, imagem, texto, publicacao, atualizacao) VALUES('$titulo', '$subtitulo', '$novo_nome' /*referente à imagem*/, '$texto', '$publicacao', '$atualizacao');";
			...
			$_SESSION['noticiarepetida'] = "Essa notícia já foi publicada anteriormente";
			echo'<META HTTP-EQUIV=Refresh CONTENT="0; URL=inserirnoticia.php">';
		}?>
		<style type="text/css">
		.imgupdate{
			width: 60%;
