...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		...
		while ($mandato = mysqli_fetch_array($query)) { ?>
			<form method="post" action="updatemandato.php">
				<div class="list-group">
					<br class="clearBoth">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-2"><?php echo $mandato["nome"]; ?></h5>
					</div>	
					<p class="mb-1 text-muted"><?php echo $mandato["ano"]; ?></p>
				</div>
				<!--<button type="button" class="btn btn-info">Atualizar</button>-->
				<INPUT TYPE="hidden" NAME="idmandato" VALUE="<?php echo $mandato['idmandato']; ?>" />
