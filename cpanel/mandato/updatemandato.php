...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		<form class="formulario" method="post" action="updatemandato1.php" enctype="multipart/form-data">
			<h1>Nome da Chapa</h1>
			<br class="clearBoth">
			...
			<br class="clearBoth">
			<input type="text" required class="form-control" maxlength="4" id="ano" name="ano" placeholder="Ano aqui">
			<small id="emailHelp" class="form-text text-muted"><?php echo $ano;  ?></small>
			<br class="clearBoth"><br class="clearBoth">

			<h1>Plano de Mandato</h1>
			<br class="clearBoth">
			...
			<a style="color: #FFF;" href="editamandato.php" class="btn btn-danger">Cancelar</a>
