...
<body style="background:#eaeaea91;">
	...
	<div style="background: #253f55;">
		<h3 style="color: white; padding: 10px; ma" class="container text-center">Inserir Dados</h3>
	</div>
	<div class="container">
		<?php
		if(isset($_SESSION['mandatorepetido'])){
			echo "<div class='alert alert-danger'>".$_SESSION['mandatorepetido']."</div>";
			unset($_SESSION['mandatorepetido']);
		}
		?>

		<form class="formulario" method="post" action="insertmandato.php" enctype="multipart/form-data">
			<h1>Nome da Chapa</h1>
			<br class="clearBoth">
