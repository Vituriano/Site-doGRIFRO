...
<body style="background:#eaeaea91;">
	...
	<div style="background-color: white;">
		...
		<ul class="container nav nav-tabs">
			...
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle active" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Planos de Mandato</a>
				<div class="dropdown-menu">
					<a class="dropdown-item" href="inseremandato.php">Inserir Plano</a>
					<a class="dropdown-item" href="editamandato.php">Atualizar Plano</a>
					<a class="dropdown-item" href="excluimandato.php">Remover Plano</a>
				</div>
			</li>
			<li class="nav-item dropdown">
	...
	<div class="container">
		<?php
		include "../conexao.php";
		$sql = "SELECT * FROM mandato ORDER BY idmandato DESC";
			...
			<form id="form1" method="post" action="">
				<div class="list-group">
					...
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-2"><?php echo $noticia["nome"]; ?></h5>
					</div>	
					<p class="mb-1 text-muted"><?php echo $noticia["ano"]; ?></p>
				</div>
				<INPUT TYPE="hidden" NAME="idmandato" VALUE="<?php echo $noticia['idmandato']; ?>" />
				<button name="1" class='btn btn-danger' id="myBtn<?php echo $noticia['idmandato'];?>" style='color: #FFF;'>Excluir</button>
			</a>
			<hr>
		</form>	
	<?php } 	
	if (isset($_POST["idmandato"])) {
		$id = $_POST['idmandato'];
		?>
		<form method="post" action="deletemandato.php">
					...
					<center>
						<div style="width: 50%;">
							<p class='text-muted'>Tem certeza que deseja Excluir?<br><br>
								<span>
									<INPUT TYPE="hidden" NAME="idmandato" VALUE="<?php echo $id; ?>" />
