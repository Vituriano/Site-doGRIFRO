...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		<form class="formulario" method="post" action="updateedital1.php" enctype="multipart/form-data">
			<h1>Título</h1>
			<br class="clearBoth">
			<input type="text" required class="form-control" id="title" name="titulo" value="<?php echo $titulo;  ?>">
			<small id="emailHelp" class="form-text text-muted"></small>
			<br class="clearBoth"><br class="clearBoth">

			<h1>Subtítulo</h1>
			<br class="clearBoth">
			<input type="text" required class="form-control" id="subtitle" name="subtitulo" value="<?php echo $subtitulo;  ?>">
			<small id="emailHelp" class="form-text text-muted"></small>
			<br class="clearBoth"><br class="clearBoth">
			...
			<div class='input-wrapper'>
				...
				<input id='input-file' name='input-file' onchange="ValidateSize(this)" type='file' value='' />
			...
			<h1>Texto</h1>
			<br class="clearBoth">
			<textarea required class="form-control" id="text" name="texto"  rows="6"><?php echo $texto;  ?></textarea>
			<small id="emailHelp" class="form-text text-muted"></small>
			<br class="clearBoth"><br class="clearBoth">

			<INPUT TYPE="hidden" NAME="idEdital" VALUE="<?php echo $id;?>" />
			<a style="color: #FFF;" href="editaredital.php" class="btn btn-danger">Cancelar</a>
