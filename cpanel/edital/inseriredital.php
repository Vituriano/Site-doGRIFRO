...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		...
		<?php
		if(isset($_SESSION['editalrepetido'])){
			echo "<div class='alert alert-danger'>".$_SESSION['editalrepetido']."</div>";
			unset($_SESSION['editalrepetido']);
		}
		?>
		<form class="formulario" method="post" action="insertedital.php" enctype="multipart/form-data">
			<h1>Título</h1>
			<br class="clearBoth">
