	...
	<div class="container">
		...
		while ($edital = mysqli_fetch_array($query)) { 
			...
			<form id="form1" method="post" action="">
				...
				<button name="1" class='btn btn-danger' id="myBtn<?php echo $edital['idEdital'];?>" style='color: #FFF;'>Excluir</button>
			</a>
			<hr>
		</form>	
	<?php } 	
	if (isset($_POST["idEdital"])) {
		$id = $_POST['idEdital'];
		?>
		<form method="post" action="deleteedital.php">
