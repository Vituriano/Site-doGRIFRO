...
<body style="background:#eaeaea91;">
	...
	<div class="container">
		...
		if(!$validations){
			...
			$query = "INSERT INTO editais (titulo, subtitulo, imagem, texto, publicacao, atualizacao) VALUES('$titulo', '$subtitulo', '$novo_nome' /*referente à imagem*/, '$texto', '$publicacao', '$atualizacao');";
			...
			$_SESSION['editalrepetido'] = "Esse edital já foi publicado anteriormente";
			echo'<META HTTP-EQUIV=Refresh CONTENT="0; URL=inseriredital.php">';
		}?>
		<style type="text/css">
		.imgupdate{
			width: 60%;
